...
extension TutorialCard {
    ...
    static func getValues() -> [TutorialCard] {
        var listReturn: [TutorialCard] = []
    ...
    static private func getValuesEmployees() -> TutorialCard {
        var listDetails: [TutorialCardDetail] = []
        
        listDetails.append(TutorialCardDetail.init(nameImage: "iconFuncBars",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconFuncRun",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconFuncDiscount",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconFuncProfessionals",
    ...
    static private func getValuesPartners() -> TutorialCard {
        var listDetails: [TutorialCardDetail] = []
        
        listDetails.append(TutorialCardDetail.init(nameImage: "iconParcGrafics",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconParcDisclose",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconParcMajorRelevancy",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconParcNumPatients",
    ...
    static private func getValuesCompanies() -> TutorialCard {
        var listDetails: [TutorialCardDetail] = []
        
        listDetails.append(TutorialCardDetail.init(nameImage: "iconEmpreCosts",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconEmpreProductivity",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconEmpreMapping",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "iconEmpreSatisfaction",
        ...
        listDetails.append(TutorialCardDetail.init(nameImage: "",
